...
include::{snippets}/AuctionApi/Bid/Failure/Case1/request-parameters.adoc[]

HTTP Response
include::{snippets}/AuctionApi/Bid/Failure/Case1/response-body.adoc[]

=== 2. 경매가 종료된 후 입찰을 진행함에 따라 예외가 발생한다
HTTP Request
...
include::{snippets}/AuctionApi/Bid/Failure/Case2/request-parameters.adoc[]
...
include::{snippets}/AuctionApi/Bid/Failure/Case3/request-parameters.adoc[]
...
include::{snippets}/AuctionApi/Bid/Failure/Case4/request-parameters.adoc[]
...
include::{snippets}/AuctionApi/Bid/Failure/Case5/request-parameters.adoc[]
...
include::{snippets}/AuctionApi/Bid/Success/request-parameters.adoc[]
