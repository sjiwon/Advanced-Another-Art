...
public enum ArtFixture {
    ...
    GENERAL_1("일반 작품 1", "일반 작품 1", GENERAL, 100_000, "21.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_2("일반 작품 2", "일반 작품 2", GENERAL, 100_000, "22.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_3("일반 작품 3", "일반 작품 3", GENERAL, 100_000, "23.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_4("일반 작품 4", "일반 작품 4", GENERAL, 100_000, "24.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_5("일반 작품 5", "일반 작품 5", GENERAL, 100_000, "25.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_6("일반 작품 6", "일반 작품 6", GENERAL, 100_000, "26.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_7("일반 작품 7", "일반 작품 7", GENERAL, 100_000, "27.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_8("일반 작품 8", "일반 작품 8", GENERAL, 100_000, "28.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_9("일반 작품 9", "일반 작품 9", GENERAL, 100_000, "29.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_10("일반 작품 10", "일반 작품 10", GENERAL, 100_000, "30.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_11("일반 작품 11", "일반 작품 11", GENERAL, 100_000, "31.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_12("일반 작품 12", "일반 작품 12", GENERAL, 100_000, "32.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_13("일반 작품 13", "일반 작품 13", GENERAL, 100_000, "33.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_14("일반 작품 14", "일반 작품 14", GENERAL, 100_000, "34.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_15("일반 작품 15", "일반 작품 15", GENERAL, 100_000, "35.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_16("일반 작품 16", "일반 작품 16", GENERAL, 100_000, "36.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_17("일반 작품 17", "일반 작품 17", GENERAL, 100_000, "37.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_18("일반 작품 18", "일반 작품 18", GENERAL, 100_000, "38.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_19("일반 작품 19", "일반 작품 19", GENERAL, 100_000, "39.png", new HashSet<>(Set.of("A", "B", "C"))),
    GENERAL_20("일반 작품 20", "일반 작품 20", GENERAL, 100_000, "40.png", new HashSet<>(Set.of("A", "B", "C"))),
    ;
