...
class MemberPointApiControllerTest extends ControllerTest {
    @Nested
    @DisplayName("포인트 충전 API [POST /api/members/{memberId}/point/charge]")
    class changeNickname {
        ...
        @Test
        @DisplayName("Authorization Header에 AccessToken이 없으면 포인트 충전을 실패한다")
        void withoutAccessToken() throws Exception {
            ...
            mockMvc.perform(requestBuilder)
                    ...
                    .andDo(
                            document(
                                    "MemberApi/Point/Charge/Failure/Case1",
                                    getDocumentRequest(),
                                    getDocumentResponse(),
                                    pathParameters(
        ...
        @Test
        @DisplayName("Token Payload가 Endpoint의 memberId와 일치하지 않음에 따라 포인트 충전을 실패한다")
        void throwExceptionByInvalidPermission() throws Exception {
            ...
            mockMvc.perform(requestBuilder)
                    ...
                    .andDo(
                            document(
                                    "MemberApi/Point/Charge/Failure/Case2",
                                    getDocumentRequest(),
                                    getDocumentResponse(),
        ...
        void success() throws Exception {
            ...
            mockMvc.perform(requestBuilder)
                    ...
                    .andDo(
                            document(
                                    "MemberApi/Point/Charge/Success",
                                    getDocumentRequest(),
                                    getDocumentResponse(),
                                    getHeaderWithAccessToken(),
                                    pathParameters(
    ...
    @Nested
    @DisplayName("포인트 환불 API [POST /api/members/{memberId}/point/refund]")
    class refundPoint {
        ...
        @Test
        @DisplayName("Authorization Header에 AccessToken이 없으면 포인트 환불을 실패한다")
        void withoutAccessToken() throws Exception {
            // when
            ...
            mockMvc.perform(requestBuilder)
                    ...
                    .andDo(
                            document(
                                    "MemberApi/Point/Refund/Failure/Case1",
                                    getDocumentRequest(),
                                    getDocumentResponse(),
                                    pathParameters(
                                            parameterWithName("memberId").description("사용자 ID(PK)")
        ...
        @Test
        @DisplayName("Token Payload가 Endpoint의 memberId와 일치하지 않음에 따라 포인트 환불을 실패한다")
        void throwExceptionByInvalidPermission() throws Exception {
            // given
            given(jwtTokenProvider.isTokenValid(anyString())).willReturn(true);
            given(jwtTokenProvider.getId(anyString())).willReturn(ANONYMOUS_ID);
            ...
            mockMvc.perform(requestBuilder)
                    ...
                    .andDo(
                            document(
                                    "MemberApi/Point/Refund/Failure/Case2",
                                    getDocumentRequest(),
                                    getDocumentResponse(),
                                    getHeaderWithAccessToken(),
                                    pathParameters(
        ...
        void throwExceptionByPointIsNotEnough() throws Exception {
            ...
            mockMvc.perform(requestBuilder)
                    ...
                    .andDo(
                            document(
                                    "MemberApi/Point/Refund/Failure/Case3",
                                    getDocumentRequest(),
                                    getDocumentResponse(),
                                    getHeaderWithAccessToken(),
                                    pathParameters(
