...
import com.sjiwon.anotherart.member.domain.repository.query.dto.response.QMemberPointRecord;
import com.sjiwon.anotherart.member.domain.repository.query.dto.response.QTradedArt;
