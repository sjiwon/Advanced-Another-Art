...
@DisplayName("Art [Validator] -> ValidImageContentTypeValidator 테스트")
class ValidImageContentTypeValidatorTest {
    private ValidImageContentTypeValidator validator;
    private ConstraintValidatorContext context;
    private ConstraintValidatorContext.ConstraintViolationBuilder builder;

    @BeforeEach
    void setUp() {
        validator = new ValidImageContentTypeValidator();
    ...
    void notAllowedExtension() throws IOException {
        // given
        final MultipartFile file = createSingleMockMultipartFile("error.webp", "image/webp");
        ...
        verify(context).buildConstraintViolationWithTemplate("이미지는 jpg, jpeg, png만 허용합니다.");
