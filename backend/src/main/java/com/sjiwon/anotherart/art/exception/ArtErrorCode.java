...
public enum ArtErrorCode implements ErrorCode {
    ...
    HASHTAG_MUST_EXISTS_AT_LEAST_ONE(BAD_REQUEST, "ART_005", "스터디 해시태그는 적어도 1개 이상 존재해야 합니다."),
    HASHTAG_MUST_NOT_EXISTS_MORE_THAN_TEN(BAD_REQUEST, "ART_006", "스터디 해시태그는 10개 이하로 작성해주세요."),
    ART_NOT_FOUND(NOT_FOUND, "ART_007", "작품 정보가 존재하지 않습니다."),
    DUPLICATE_NAME(CONFLICT, "ART_008", "이미 사용중인 작품명입니다."),
    SORT_TYPE_NOT_PROVIED(BAD_REQUEST, "ART_009", "제공하지 않는 정렬 타입입니다."),
    CANNOT_DELETE_SOLD_ART(CONFLICT, "ART_0010", "이미 판매된 작품은 삭제할 수 없습니다."),
