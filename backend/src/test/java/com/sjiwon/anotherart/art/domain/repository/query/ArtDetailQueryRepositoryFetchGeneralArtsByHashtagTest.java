...
@DisplayName("Art -> ArtDetailQueryRepository [fetchGeneralArtsByHashtag] 테스트")
public class ArtDetailQueryRepositoryFetchGeneralArtsByHashtagTest extends ArtDetailQueryRepositoryTestSupporter {
    @Nested
    ...
    class FetchGeneralArtsByHashtag {
        ...
        void dateAsc() {
            final Page<GeneralArt> result1 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(0), pageable1);
            assertAll(
            ...
            final Page<GeneralArt> result2 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(0), pageable2);
            assertAll(
        ...
        void dateDesc() {
            final Page<GeneralArt> result1 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(1), pageable1);
            assertAll(
                    () -> assertThat(result1.hasPrevious()).isFalse(),
                    () -> assertThat(result1.hasNext()).isTrue()
            );
            ...
            final Page<GeneralArt> result2 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(1), pageable2);
            assertAll(
                    () -> assertThat(result2.hasPrevious()).isTrue(),
                    () -> assertThat(result2.hasNext()).isFalse()
            );
        ...
        void priceAsc() {
            final Page<GeneralArt> result1 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(2), pageable1);
            assertAll(
                    () -> assertThat(result1.hasPrevious()).isFalse(),
                    () -> assertThat(result1.hasNext()).isTrue()
            );
            ...
            final Page<GeneralArt> result2 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(2), pageable2);
            assertAll(
                    () -> assertThat(result2.hasPrevious()).isTrue(),
                    () -> assertThat(result2.hasNext()).isFalse()
            );
        ...
        void priceDesc() {
            final Page<GeneralArt> result1 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(3), pageable1);
            assertAll(
                    () -> assertThat(result1.hasPrevious()).isFalse(),
                    () -> assertThat(result1.hasNext()).isTrue()
            );
            ...
            final Page<GeneralArt> result2 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(3), pageable2);
            assertAll(
                    () -> assertThat(result2.hasPrevious()).isTrue(),
                    () -> assertThat(result2.hasNext()).isFalse()
            );
        ...
        void likeAsc() {
            final Page<GeneralArt> result1 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(4), pageable1);
            assertAll(
                    () -> assertThat(result1.hasPrevious()).isFalse(),
                    () -> assertThat(result1.hasNext()).isTrue()
            );
            ...
            final Page<GeneralArt> result2 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(4), pageable2);
            assertAll(
                    () -> assertThat(result2.hasPrevious()).isTrue(),
                    () -> assertThat(result2.hasNext()).isFalse()
            );
        ...
        void likeDesc() {
            final Page<GeneralArt> result1 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(5), pageable1);
            assertAll(
                    () -> assertThat(result1.hasPrevious()).isFalse(),
                    () -> assertThat(result1.hasNext()).isTrue()
            );
            ...
            final Page<GeneralArt> result2 = sut.fetchGeneralArtsByHashtag(generalArtSearchConditions.get(5), pageable2);
            assertAll(
                    () -> assertThat(result2.hasPrevious()).isTrue(),
                    () -> assertThat(result2.hasNext()).isFalse()
            );
