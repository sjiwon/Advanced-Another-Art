...
public enum MemberErrorCode implements ErrorCode {
    ...
    INVALID_POINT_RANGE(HttpStatus.BAD_REQUEST, "MEMBER_004", "포인트에 대한 요청은 음수가 허용되지 않습니다."),
    ...
    INVALID_INFORMATION(HttpStatus.BAD_REQUEST, "MEMBER_014", "사용자 정보가 일치하지 않습니다."),
